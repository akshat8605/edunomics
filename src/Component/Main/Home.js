    ...
    return (
        <div className="" >
            <section className="homecontainer section" id="home"> 
                <div className="row ">
                    <div className="col l6 m12 s12 section landingpagediv padb" >
                        <h4 className="left-align valign-wrapper"><b>WELCOME TO THE WORLD OF EDUNOMICS</b></h4>
                        <SearchForm />

                    </div>
                    <div className=" col l6 m12 s12 ">
                        <img src={Heroimage} height='500px' alt="Home page image" style={{marginTop:"100px"}} className="img-responsive heroimage"></img>
                    </div>
                </div>
            </section>
